...
```{r}
rr_model %>% nearest_to(rr_model[["cloth"]], 50)
...
living_cargo = nearest_to(rr_model, rr_model[[c("sheep", "swine", "hogs", "goats", "cattle", "cows", "pigs", "mules", "calves")]], 150)
...
Simply plotting the model shows some interesting clusters. For example, the words "negligence, "injury," "damage," "jury," and "defendent" are all clustered together. As are
```{r}
plot(rr_model)
```
